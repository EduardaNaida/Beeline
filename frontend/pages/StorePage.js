...
/**
 *  Displays information for the secondpage for a chosen store's outsidequeue. Like the logo, 
 *  adress, people in store, waiting time and people in line. Also makes it possible 
 *  to stand in line for each store's outside queue and return to homepage.
...
function StorePage(){
    ...
    useEffect(() => {
            /************* get Queue length *************/
            axios.get('/API/v1/queue/length/'+id)
            .then((response) => {
                ...
                <div className={classes.question}>           
                    <Paper className={classes.paper} style={{ marginLeft: '0%',marginTop: '30px'}}>
                        <Typography variant="h3" component="h2" className={classes.questionText}>
                            The store is full, do you want to queue to get into the store?
                        </Typography>
                    </Paper>
                </div>
            </Grid>
